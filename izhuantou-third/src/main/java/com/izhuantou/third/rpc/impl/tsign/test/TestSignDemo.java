package com.izhuantou.third.rpc.impl.tsign.test;

import java.io.File;

import com.izhuantou.third.rpc.impl.tsign.eSign.SignHelper;
...
public class TestSignDemo {
	...
	// 待签署的PDF文件路径
	String srcPdfFile = "D:/pdf/test3.pdf";
	// 最终签署后的PDF文件路径
	String signedFolder = "D:/pdf/";
	// 最终签署后PDF文件名称
	String signedFileName = "test4.pdf";
