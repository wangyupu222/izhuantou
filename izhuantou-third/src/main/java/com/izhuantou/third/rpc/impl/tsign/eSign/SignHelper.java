package com.izhuantou.third.rpc.impl.tsign.eSign;
...
public class SignHelper {
	...
	// 项目ID(应用ID)
	proCfg.setProjectId("1111564539");// 1111563517
	// 项目Secret(应用Secret)
	proCfg.setProjectSecret("4bae0973f0249a78633b83c4c6b8a285"); // 95439b0863c241c63a861b87d1e647b7
	// 开放平台地址
	proCfg.setItsmApiUrl("http://itsm.tsign.cn/tgmonitor/rest/app!getAPIInfo2");
	...
	// 设置坐标定位签署的PosBean，坐标定位方式支持单页签章、多页签章和骑缝章，但对关键字签章指定页码无效；
	PosBean posBean = setKeyPosBean("乙方签章", 110, 0, 90);
	// 设置签署类型为 关键字签章
    ...
    /***
     * 上传印章图片制作SealData； 使用到接口：Apache Commons
     * Codec的org.apache.commons.codec.binary.Base64 该方法属于 第三方jar实现，并非快捷签SDK提供；
     */
