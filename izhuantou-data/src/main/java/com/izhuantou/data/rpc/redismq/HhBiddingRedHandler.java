 ...
 * 环环投Message消息的处理器
 * 
 * @category @author sweet
 * @since 2018年5月8日
 */
@Service
public class HhBiddingRedHandler extends AbstarctMessageHandler {
...
/*
	public HhBiddingRedHandler() {
		// 说明该handler监控的消息类型
		super(MessageType.HH_RED_BIDDING_MESSAGE, 10);
	}*/
	public HhBiddingRedHandler() {
		super(MessageType.HH_RED_BIDDING_MESSAGE, 10);
	...
	public void handle(String message) {
		...
		String s = this.controlPackageBidding.bidPackageBiddingRed(biddingDTO);
