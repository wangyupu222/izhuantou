 ...
 */
@Service
public class HhBiddingRedAndPrivilege extends AbstarctMessageHandler{
	private static Log logger = LogFactory.getLog(HhBiddingHandler.class);

    @Autowired
    private ControlPackageBiddingMainRuning controlPackageBidding;

    public HhBiddingRedAndPrivilege() {
	// 说明该handler监控的消息类型
	super(MessageType.HH_RED_PRIVILEGE_BIDDING_MESSAGE, 10);
    }
	...
	String s = this.controlPackageBidding.bidPackageBiddingRedAndPrivilege(biddingDTO);
