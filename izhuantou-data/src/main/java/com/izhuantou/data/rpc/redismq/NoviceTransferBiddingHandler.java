 ...
 */
@Service
public class NoviceTransferBiddingHandler extends AbstarctMessageHandler {
    private static Log logger = LogFactory.getLog(NoviceTransferBiddingHandler.class);

    @Autowired
    private ControlNoviceBidding controlNoviceBidding;

    public NoviceTransferBiddingHandler() {
	// 说明该handler监控的消息类型
	super(MessageType.NOVICE_TRANSFER_BIDDING_MESSAGE, 10);
    }
	...
	String s = this.controlNoviceBidding.bidNoviceBiddingZz(biddingDTO);
