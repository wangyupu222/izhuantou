...
public class ToolClient {
     ...
     * @throws Exception
     */
    public static Map<String, String> sendSMS(String strMobile, String userName, String password, String strOld,
	    Map<String, String> dtoData) throws Exception {
	try {

	    String content = ToolString.replaceContent(strOld, dtoData);
	    Map<String, String> msm = new HashMap<String, String>();
	    msm.put("mobiles", strMobile);
	    msm.put("userName", userName);
	    msm.put("password", password);
	    msm.put("content", content);
	    return ToolClient.sendSMSContent(msm);
	} catch (Throwable cause) {
	    throw new Exception("是否存在失败", cause);
	}
    }
	...
	try {
	    ...
	    String extNumber = "";
	    String planSendTime = "";
	    HttpPost post = new HttpPost("https://dx.ipyy.net/webservice.asmx?wsdl");
