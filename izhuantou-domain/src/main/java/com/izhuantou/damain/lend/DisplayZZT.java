 ...
 *
 */
public class DisplayZZT extends BasePojo {
    /**
     * 序列化
     */
	...
	return "DisplayZZT [OID=" + OID + ", xmmc=" + xmmc + ", productStatus=" + productStatus + ", nhll=" + nhll
		+ ", cjqx=" + cjqx + ", hkfs=" + hkfs + ", rate=" + rate + ", sy=" + sy + ", xmze=" + xmze + ", sykt="
		+ sykt + ", sortp=" + sortp + ", holdingAmount=" + holdingAmount + ", bdtj1=" + bdtj1 + ", jd=" + jd
		+ ", szds=" + szds + "]";
    }
