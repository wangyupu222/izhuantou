 ...
 * @version 1.0
 */
@Table(name = "p2p_toutiaonews")
public class P2pToutiaoNews extends BasePojo {
    /**
     * 
     */
    private static final long serialVersionUID = 2001086475069634185L;
	...
	return "P2pToutiaoNews [OID=" + OID + ", name=" + name + ", author=" + author + ", uploadImg=" + uploadImg
		+ ", uploadImgOID=" + uploadImgOID + ", messages=" + messages + ", describe0=" + describe0 + ", NO="
