...
public class P2pNotice extends BasePojo {

    /**
     * 
     */
    private static final long serialVersionUID = -8799990016787579268L;
    @Id
    @Column(name = "OID")
    private String OID;
    /**
	...
	return "P2pNotice [OID=" + OID + ", name=" + name + ", author=" + author + ", uploadImg=" + uploadImg
