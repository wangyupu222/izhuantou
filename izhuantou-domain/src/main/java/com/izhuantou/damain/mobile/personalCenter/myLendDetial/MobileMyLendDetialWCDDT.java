...
public class MobileMyLendDetialWCDDT extends BasePojo {
	...
	return "MobileMyLendDetialWCDDT [productType=" + productType + ", hkzt=" + hkzt + ", biOID=" + biOID
		...
		+ ", ruleIntroduce=" + ruleIntroduce + ", cjsjDate=" + cjsjDate + ", tatalTerm=" + tatalTerm + ", yslx="
		+ yslx + ", startDateTime=" + startDateTime + ", endDateTime=" + endDateTime + "]";
    }
