...
/**
 * 房抵产品企业标的的录入后会存在webp2p_mecloancenterinfo下 后台录入
 * 
 * @author dear
 * @version 1.0
 */
@Table(name = "webp2p_mecloancenterinfo")
public class WebP2pMecLoanCenterInfo extends BasePojo {
    /**
     * 
     */
	...
	return "HX_MecLoanCenterInfo [OID=" + OID + ", customername=" + customername + ", sex=" + sex + ", age=" + age
		...
		+ loandeadline + ", isAgree=" + isAgree + ", dkcplx=" + dkcplx + ", company=" + company + ", trade="
		+ trade + ", establishedTime=" + establishedTime + ", registeredCapital=" + registeredCapital
		+ ", companyAddress=" + companyAddress + ", creditStatus=" + creditStatus + ", beizhu=" + beizhu
		+ ", beizhufs=" + beizhufs + ", location=" + location + ", cqNum=" + cqNum + ", area=" + area + ", qt="
		+ qt + ", describe0=" + describe0 + ", NO=" + NO + ", addUserOID=" + addUserOID + ", updUserOID="
