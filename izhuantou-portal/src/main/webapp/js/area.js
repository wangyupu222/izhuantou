...
function change(v){
	...
	with(ss){
		length = 0;
		options[0]=new Option(opt0[v],optvalue[v]);
...
dsy.add("0_0_0",["东城区","西城区","朝阳区","丰台区","石景山区","海淀区","门头沟区","房山区","通州区","顺义区","昌平区","大兴区","怀柔区","平谷区","密云县","延庆县","延庆镇"]);
dsy.add("0_0",["北京市"]);
...
dsy.add("0_19_11",["莞城区","常平镇","塘厦镇","万江区","虎门镇"]);
...
dsy.add("0_21_1",["三亚湾","海棠区","吉阳区","天涯区","崖州区"]);
