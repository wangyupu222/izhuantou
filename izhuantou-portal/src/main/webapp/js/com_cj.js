...
$(function(){
	$('.hht_tabtitcons.tabtitcons div').click(function(){
		...
		url=url+$('.tabtitcons div').index(this);
		//alert("url3"+url)
		window.location.href=url;
		
			
		});
	$('.ddt_tabtitcons.tabtitcons div').click(function(){
		$(this).addClass('active').siblings().removeClass('active');
		$('.optabg').eq($('.tabtitcons div').index(this)).show().siblings().hide();
		//alert("aaa:"+$('.tabtitcons div').index(this));
		$("#tabInx").attr("value",$('.tabtitcons div').index(this));
	...
	$('.tbz_tabtitcons.tabtitcons div').click(function(){
		$(this).addClass('active').siblings().removeClass('active');
		$('.optabg').eq($('.tabtitcons div').index(this)).show().siblings().hide();
		//alert("aaa:"+$('.tabtitcons div').index(this));
		$("#tabInx").attr("value",$('.tabtitcons div').index(this));
	...
	$('.zzt_tabtitcons.tabtitcons div').click(function(){
		$(this).addClass('active').siblings().removeClass('active');
		$('.optabg').eq($('.tabtitcons div').index(this)).show().siblings().hide();
		//alert("aaa:"+$('.tabtitcons div').index(this));
		$("#tabInx").attr("value",$('.tabtitcons div').index(this));
	...
	$('.zzt2_tabtitcons.tabtitcons div').click(function(){
		$(this).addClass('active').siblings().removeClass('active');
		$('.optabg').eq($('.tabtitcons div').index(this)).show().siblings().hide();
		//alert("aaa:"+$('.tabtitcons div').index(this));
		$("#tabInx").attr("value",$('.tabtitcons div').index(this));
...
$(function(){
	var oHeight=$(window).height();
	$(".projectscon").css({"min-height":oHeight-530})
})
$(window).resize(function(){
	var oHeight=$(window).height();
	$(".projectscon").css({"min-height":oHeight-530})
...
function iniTab(){
	 ...
	 tabVlue=$("#tabInx").val();
	 //alert("bbb:"+tabVlue);
	 $(".tabtitcons div").eq(tabVlue).addClass('active').siblings().removeClass('active');
		 $('.optabg').eq(tabVlue).show().siblings().hide();
