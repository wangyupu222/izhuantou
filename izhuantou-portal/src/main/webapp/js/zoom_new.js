(function($) {
	$('body').append('<div id="zoom"><a class="close"></a><a href="#previous" class="previous"></a><a href="#next" class="next"></a><div><div class="content loading"></div><h3 class="con_tit"></h3></div></div>');
	...
	(function bindNavigation() {
		...
		//$("#iframepage_hht").contents().find(".informationImg_wrap .informationImg_box a");
		 ...
		 $(document).on('click','.informationImg_wrap .informationImg_box a',open01);
	})();
