...
<style>
.rowbox06 span.shortspan{width:12.6%;}
.rowbox06 span.longspan{ width:17.6%;}
.rowbox06 li.shortspan{width:12.6%;}
.rowbox06 li.longspan{ width:17.6%;}
       ...
       <div class="yunull yunullchujie">
            ...
            <div class="ljhkbox">
                	<div class="ljhkboxone">
                    	<span class="sp01"><em>18</em>%</span>
                        <span class="sp02">借款利率</span>
                    </div>
                    
                    <div class="ljhkboxone">
                    	<span class="sp01"><em>12</em>个月</span>
                        <span class="sp02">借款期限</span>
                    </div>
                    
                    <div class="ljhkboxone">
                    	<span class="sp01"><em>150000</em>元</span>
                        <span class="sp02">借款金额</span>
                    </div>
                    
                    <div class="ljhkboxone">
                    	<span class="sp01 blue"><em>1863</em>元</span>
                        <span class="sp02">应还金额</span>
                    </div>
                </div>
            <div class="zhye"><span class="sp1">账户余额</span><span class="sp2"><em>633</em>元</span></div>
        ...
        <p class="commit-2"><!--<span>理财有风险，投资需谨慎</span>--><a class="colseok" href="tzdetailsok.jsp">确认</a><span class="spjineyue">账户余额不足，请<a href="Recharge.jsp" class="cz">充值</a></span></p>
   </div>    
    <!--确认出借结束-->
...
<div class="main minhh">
	<div class="con personcon">
    	...
    	<div class="xqdeleft my_loan">
        	<div class="my_loantop"><a href="#" class="active">借款记录</a><span class="L1">&nbsp;</span></div>
            <div class="clear"></div>
            <div>
            <!--出借记录-->
            ...
            <div >
            	<div class="mytzcon">
                	...
                	<span class="longspan">借款标题</span>
                	<span>借款金额(元)</span>
                	<span class="shortspan">借款利率</span>
                	<span class="longspan">借款时间</span>
                	<span>下个还款日</span>                	
                	<span class="shortspan">状态</span>
                	<span class="shortspan">协议</span>
                	</div>
                   <div class="listItem">
                   </div>	
				<div class="hide_liu JKjilu_liu"></div>	
				<!--分页-->
					  <web:PartPage2 name="dtocListJKRecordsCollection" customProperty = "class=\"page\""  customSelectProperty="class=\"active\""/>
					 <!--分页结束-->
