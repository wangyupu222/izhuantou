  	...
  	<%@ include file="left_percenter.jsp" %> 
    	...
    	<div class="xqdeleft my_loan">
            ...
            <div class="optab">
                <div class="hkz">
                <div class="msgbox">
                <div class="msgbox-status"><a href="MessageNotification.jsp">未读消息</a><a  class="active" href="MessageHistoryNotification.jsp" >已读消息</a></div>
                ...
                <div id="MessageHistoryWrap">
				
				</div>
                
                <div class="hide_liu Message02_liu"></div>
                 <!--分页-->
...
$(function(){
	...
	$.ajax({
        dataType:"json",
        url:"/portal/personal/historyMessage",
        data:{
        	currentpage:1
        },		
        success: function(result){
        	...
        	if(result.totalNumber<1){
    	        $(".Message02_liu").css("display","block");
    	    }
        	$("#page").paging({
