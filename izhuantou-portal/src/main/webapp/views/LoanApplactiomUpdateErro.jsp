...
<div class="main mainscok minhh">
    <div class="con jksucess">
        <div class="succ">
        <div class="scok-p scok-error"><span></span>异常提示<hoontag:Message /></div>
        <%-- <div class="bott-p"><hoontag:Message /></div> --%>
        
        <div class="btn"><a onclick="window.history.back();" class="btn-a">返回我的申请记录</a><span class="timetxt"><span id="time">5</span>秒后自动跳转首页，<a >点击立刻跳转。</a></span></div>
        </div>
    </div>
</div>
<!--资料上传成功结束-->        
