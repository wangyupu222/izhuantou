...
body{ background-color:#fff !important;}
 /*返回成功页面*/
	...
	.dlk a{text-decoration:none; outline:none;display:block; width:33%; font-size:14px; height:40px; background-color:#32b7fc; color:#fff; border-radius:25px; line-height:40px; text-align:center;float:left;-webkit-box-shadow: 0px 3px 2px rgba(50, 183, 252, 0.7);   
...
<div class="rigthfh">
        <div class="rightout">
            ...
            <p>您的操作已受理</p>
            <p>稍后返回个人中心即可查看充值结果</p>
            <%-- <p>您的账户余额：<span><%=request.getAttribute("availablemoney")%></span>元</p> --%>
            </div>
        </div>
        <div class="dlk dlkerror"><a class="backPersonalCenter"  href="javascript:void(0);">返回用户中心</a> <a class="continuereCharge" style="float:right;" href="javascript:void(0);">继续充值</a><div style="clear:both;"></div></div>
    <div class="phone_wrap ServiceTel"><p>客服电话：400-900-9677</p><span>（周一至周五：9:00-18:00）</span></div>
    </div>
