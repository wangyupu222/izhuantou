...
<body>
	...
	<div class="banner_reg">
		<div style="height: 100%; width: 100%; z-index: 1;">
			<a style="z-index: 1; display: inline-block; width: 100%; height: 100%;" href="/notice_details.jsp?OID=471c1667f5d3f6e221c00655ca9a58c2"></a>
		</div>
		<div class="banner_wrap">
			<div class="register_content">
				<div class="registright">
					<form action="/portal/user/regist" method="post" id="FormRegister" name="FormRegister">
						...
						<div class="regist_inpt yzm short short2">
							...
							<a href="#" class="num_yzm"><img width="110" height="40" src="checkcode" class="m" alt="如果看不清,请点击我!" title="如果看不清,请点击我!" "  onclick="this.setAttribute('src','checkcode?x='+Math.random());" ></a>

						</div>
						<div class="regist_inpt yzm short sms_yzm ">
							<input type="text" name="msm" id="yzm_reg" placeholder='请输入短信验证码' required onfocus="this.placeholder=''" onblur="this.placeholder='请输入短信验证码'"  />
						</div>
						...
						<div class="regist_check xieyi_text">
							<label class="checklabel checklabel01"><input type="checkbox" name="isAgree" id="isAgree" value="ok" checked='checked' required data-msg-required='必选' />我已阅读并同意</label> <a href="/agreement_z.jsp?contractType=1&biddingType=qt" target="_blank" class="ra">《砖头网注册协议》</a>
						</div>
	...
	<div class="register_hongbao">
		<div class="hongbao_main">
			<div class="register_box register_box_new">
				...
				<div class="introduced_text introduced_text02">
			...
			<div class="register_box register_box_new" style="min-height: 670px;">
				...
				<div class="introduced_text">
					2017年6月29日 9:00起，注册砖头网，即可获得9%加息券奖励，<br>注册成功，9%加息券奖励飞入您的口袋
				</div>
		...
		<div class="register_box register_box02">
			...
			<div class="safe_wrap">
				<div class="safe_box">
					...
					<p>海量真实融资项目</p>
					<div class="safe_text">
						全面信息披露与优质真实的融资项目，<br>真诚相待每一位平台用户，保障平台信息<br>完全透明。
					</div>
					<div class="safe_btn">
						<a href="security.jsp">more</a>
					</div>
				</div>
				<div class="safe_box safe_box02">
					...
					<p>保理公司竭力服务</p>
					<div class="safe_text">
						质保服务专款与保理公司战略合作<br>双保险，尽心尽责对待应收账款，保障出借人<br>的根本利益。
					</div>
					<div class="safe_btn">
						<a href="security.jsp">more</a>
					</div>
				...
				<div class="safe_box safe_box03">
					...
					<p>三方资金稳健托管</p>
					<div class="safe_text">
						第三方资金托管是目前业内公认的合理<br>安全模式，有效保证平台杜绝归集出借人<br>资金的问题。
					</div>
					<div class="safe_btn">
						<a href="security.jsp">more</a>
					</div>
				...
				<div class="safe_box safe_box04">
					...
					<p>法律合规全程保障</p>
					<div class="safe_text">
						采用阿里云云服务ECS技术支持，<br>骨干机房搭配独享带宽、云盾DDoS高防IP<br>系统等一系列专业技术手段。
					</div>
					<div class="safe_btn">
						<a href="security.jsp">more</a>
					</div>
		...
		<div class="register_box register_box04">
			...
			<div class="product_wrap">
				<div class="product_box">
					<a href="NewProjects.jsp"></a>
				</div>
				<div class="product_box">
					<a href="projects.jsp?startTerm=1&endTerm=1&startRate=0&endRate=100&selType=hh"></a>
				</div>
				<div class="product_box product_box03">
					<a href="projects.jsp?startTerm=3&endTerm=3&startRate=0&endRate=100&selType=hh"></a>
				</div>
				<div class="product_box product_box04">
					<a href="projects.jsp?startTerm=6&endTerm=6&startRate=0&endRate=100&selType=hh"></a>
				</div>
				<div class="product_box product_box05">
					<a href="projects.jsp?startTerm=12&endTerm=12&startRate=0&endRate=100&selType=hh"></a>
				</div>
				<div class="product_box product_box06" style="margin-right: 0px;">
					<a href="projects.jsp?startTerm=13&endTerm=100&startRate=0&endRate=100&selType=hh"></a>
				</div>

				<%-- <img src="images/register_New/product_wrap.jpg"> --%>
			</div>
