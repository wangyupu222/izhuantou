...
if (/ndroid/i.test(navigator.userAgent) || /(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) {
    top.location.href = 'App/WYingRegisterM.jsp';
} 
function huoquyzm(){	
...
<div class="banner_reg">
    ...
    <form handleClassName="SpreadRegistWeb" name="FormRegister"  >
    	...
    	<input type="hidden" value="wangying" readonly="readonly" name="Channel"/>
    	<input type="hidden" value="WYing" readonly="readonly" name="typeVal"/>
		...
		<input type="hidden" name="yqm_reg" id="yqm_reg" placeholder='请输入推荐人手机号' readonly="readonly" value="13601118212" /> 
