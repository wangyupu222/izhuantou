...
<% try{ %>
	...
	<div class="wrap">
		<img class="APPregisterBanner" src="/image/registerActive/APPregisterBanner.jpg?v=114">
		...
		<img class="APPregisterCon" src="/image/registerActive/APPregisterCon01.jpg?v=114">
