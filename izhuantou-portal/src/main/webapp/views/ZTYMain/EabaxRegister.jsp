...
if (/ndroid/i.test(navigator.userAgent) || /(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) {
    top.location.href = 'App/EabaxRegisterM.jsp';
} 
function huoquyzm(){	
...
<div class="banner_reg">
    ...
    <form handleClassName="SpreadRegistWeb" name="FormRegister"  >
    	...
    	<input type="hidden" value="jinsuanpan" readonly="readonly" name="Channel"/>
    	<input type="hidden" value="Eabax" readonly="readonly" name="typeVal"/>
