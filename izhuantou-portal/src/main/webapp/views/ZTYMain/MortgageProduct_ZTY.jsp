...
<div class="Mortgage_banner">
    <img class="banner_tit01" src="<%=pathUrl %>/image/MortgageProduct/banner_tit01.png">
    <img class="banner_tit02" src="<%=pathUrl %>/image/MortgageProduct/banner_tit02.png">
</div>
<div class="Mortgage_con">
    <div class="Mortgage_main">
        <div class="box01">
            ...
            <div class="box01_bot">
                <div class="box">
                    <img src="<%=pathUrl %>/image/MortgageProduct/Shape-01.png">
                    <p>商品房、写字楼、别墅等具有流通价值房产产权清晰，易变现。</p>
                </div>
                <div class="box">
                    <img src="<%=pathUrl %>/image/MortgageProduct/Shape-02.png">
                    <p>充分利用大数据征信技术，综合评估其信用状况，必须无法院执行人诉讼案件。</p>
                </div>
                <div class="box">
                    <img src="<%=pathUrl %>/image/MortgageProduct/Shape-03.png">
                    <p>实地勘探，多维度评估房价，最终估价以标的实际情况为准。</p>
                </div>
                <div class="box">
                    <img src="<%=pathUrl %>/image/MortgageProduct/Shape-04.png">
                    <p>借款期限以3、6、12月为主，投资期限短，风险小。</p>
                </div>
                <div class="box box02">
                    <img src="<%=pathUrl %>/image/MortgageProduct/Shape-05.png">
        ...
        <div class="box01 box02">
            ...
            <div style="height: 20px;"></div>
            <img src="<%=pathUrl %>/image/MortgageProduct/box_02Img.png">
        </div>
        <div class="box01 box03">
            <div class="box01_tit"><span>安全措施全力保障——值得托付</span></div>
            <div style="height: 20px;"></div>
            <img src="<%=pathUrl %>/image/MortgageProduct/box_03Img.png">
        </div>
