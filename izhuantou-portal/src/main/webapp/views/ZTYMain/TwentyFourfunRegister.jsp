...
if (/ndroid/i.test(navigator.userAgent) || /(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) {
    top.location.href = 'App/TwentyFourfunRegisterM.jsp';
} 
function huoquyzm(){	
...
<div class="banner_reg">
    ...
    <form handleClassName="SpreadRegistWeb" name="FormRegister"  >
    	...
    	<input type="hidden" value="24quba" readonly="readonly" name="Channel"/>
    	<input type="hidden" value="TwentyFourfun" readonly="readonly" name="typeVal"/>
