...
if (/ndroid/i.test(navigator.userAgent) || /(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) {
    top.location.href = 'App/StoneKeRegisterM.jsp';
} 
function huoquyzm(){	
...
<div class="banner_reg">
    ...
    <form handleClassName="SpreadRegistWeb" name="FormRegister"  >
    	...
    	<input type="hidden" value="shitouke" readonly="readonly" name="Channel"/>
    	<input type="hidden" value="StoneKe" readonly="readonly" name="typeVal"/>
