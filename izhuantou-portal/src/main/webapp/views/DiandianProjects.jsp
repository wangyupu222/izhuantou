...
<div class="main conheight">
	<div class="con projectscon">
    	<div class="projectscon_tit"><img src="/images/dual_system/ddtProject_tit.png"></div>
        <div class="bottomlist bottomlist01">
        	...
        	<thead>
            	<tr class="tr01">
                    ...
                    <td width="10.3%"><a href="DiandianProjects.jsp?sortp=nhll2asc">预期年化收益&nbsp;&nbsp;<em id="sortnhll"><img src="/images/dual_system/triangle_bottom.png"></em></a></td>
                    <%}else{ %>
                    <td width="10.3%"><a href="DiandianProjects.jsp?sortp=nhll2desc">预期年化收益&nbsp;&nbsp;<em id="sortnhll"><img src="/images/dual_system/triangle_top.png"></em></a></td>
                    <%} %>
                    
                    <%if("cjqx2desc".equals(request.getParameter("sortp"))) {%>
                    <td width="10.3%"><a href="DiandianProjects.jsp?sortp=cjqx2asc">出借期限&nbsp;&nbsp<em id="sortcjqx"><img src="/images/dual_system/triangle_bottom.png"></em></a></td>
                    <%}else{ %>
                    <td width="10.3%"><a href="DiandianProjects.jsp?sortp=cjqx2desc">出借期限&nbsp;&nbsp<em id="sortcjqx"><img src="/images/dual_system/triangle_top.png"></em></a></td>
                    <%} %>
                    
                    <%if("hkfs2desc".equals(request.getParameter("sortp"))) {%>
                    <td width="12.3%"><a href="DiandianProjects.jsp?sortp=hkfs2asc">回款方式&nbsp;&nbsp;<em id="sorthkfs"><img src="/images/dual_system/triangle_bottom.png"></em></a></td>
                    <%}else{ %>
                    <td width="12.3%"><a href="DiandianProjects.jsp?sortp=hkfs2desc">回款方式&nbsp;&nbsp;<em id="sorthkfs"><img src="/images/dual_system/triangle_top.png"></em></a></td>
                    <%} %>
                    
                    <%if("xmze2desc".equals(request.getParameter("sortp"))) {%>
                    <td width="12.3%"><a href="DiandianProjects.jsp?sortp=xmze2asc">标的金额&nbsp;&nbsp;<em id="sortxmze"><img src="/images/dual_system/triangle_bottom.png"></em></a></td>
                    <%}else{ %> 
                    <td width="12.3%"><a href="DiandianProjects.jsp?sortp=xmze2desc">标的金额&nbsp;&nbsp;<em id="sortxmze"><img src="/images/dual_system/triangle_top.png"></em></a></td>
                     <%} %> 
                     
                     <%if("sykt2desc".equals(request.getParameter("sortp"))) {%>
                    <td width="12.3%"><a href="DiandianProjects.jsp?sortp=sykt2asc">剩余金额&nbsp;&nbsp;<em id="syktxmze"><img src="/images/dual_system/triangle_bottom.png"></em></a></td>
                    <%}else{ %> 
                    <td width="12.3%"><a href="DiandianProjects.jsp?sortp=sykt2desc">剩余金额&nbsp;&nbsp;<em id="syktxmze"><img src="/images/dual_system/triangle_top.png"></em></a></td>
                     <%} %> 
