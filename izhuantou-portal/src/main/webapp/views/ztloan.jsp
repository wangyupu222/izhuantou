...
<div class="main jdpart">
	<div class="con jdpcons">
    	<div class="navwrap">
    	<div class="navMain">
    	<div class="nav01 active"><img src="<%=pathUrl %>/images/loanMain_New/credit_atv.png"></div>
        <div class="nav02"><img src="<%=pathUrl %>/images/loanMain_New/mortgage.png"></div>
    	</div>        	
        </div>
        <div class="loanObj">
        ...
        <img class="loanImg loanIYDimg" src="<%=pathUrl %>/images/loanMain_New/loan_IYDimg.png">
        ...
        <img class="loanImg loanIXDimg" src="<%=pathUrl %>/images/loanMain_New/loan_IXDimg.png">
        ...
        <img class="loanImg loanIBDimg" src="<%=pathUrl %>/images/loanMain_New/loan_IBDimg.png">
        ...
        <img class="loanImg loanIFangDimg" src="<%=pathUrl %>/images/loanMain_New/loan_IFangDimg.png">
        ...
        <img class="loanImg loanICDimg" src="<%=pathUrl %>/images/loanMain_New/loan_ICDimg.png">
...
$(function(){
	$(".navMain div").click(function(){
		...
		if($(".navMain .nav01").hasClass("active")){
			$(".navMain .nav01").find("img").attr("src","<%=pathUrl %>/images/loanMain_New/credit_atv.png");
		}else{
			$(".navMain .nav01").find("img").attr("src","<%=pathUrl %>/images/loanMain_New/credit.png");
		}
		if($(".navMain .nav02").hasClass("active")){
			$(".navMain .nav02").find("img").attr("src","<%=pathUrl %>/images/loanMain_New/mortgage_atv.png");
		}else{
			$(".navMain .nav02").find("img").attr("src","<%=pathUrl %>/images/loanMain_New/mortgage.png");
		}
	})
	var n=1;
