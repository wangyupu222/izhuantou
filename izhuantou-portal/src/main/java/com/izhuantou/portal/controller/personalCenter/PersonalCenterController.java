...
public class PersonalCenterController {
	...
	String memberOID = (String) session.getAttribute("memberOID");
	userdto.setOID(memberOID);
	String result = personalMessage.insertTwoQuestion(userdto);
	return "redirect:/portal/personal/Securitypre";
    }
	...
	String memberOID = (String) session.getAttribute("memberOID");
	String str = null;
	Map<String, Integer> message = this.personalMessage.findMessageNum(memberOID);
	...
	String memberOID = (String) session.getAttribute("memberOID");
	String str = null;
	Pagination<MessageContentBusiness> list = this.personalMessage.findMessage(currentpage, memberOID);
	...
	String memberOID = (String) session.getAttribute("memberOID");
	String str = null;
	Pagination<MessageContentBusiness> list = this.personalMessage.findHistoryMessage(currentpage, memberOID);
