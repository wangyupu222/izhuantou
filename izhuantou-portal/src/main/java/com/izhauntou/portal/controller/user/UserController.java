package com.izhauntou.portal.controller.user;
...
public class UserController {
    ...
    @ResponseBody
    public OpResult testRegist(UserDTO us) {
	String rows = userService.registUser(us);

	return OpResult.getSuccessResult(rows);

    }

    @RequestMapping(value = "/testyao", method = RequestMethod.POST)
    @ResponseBody
    public OpResult testyao(UserDTO us) {

	Map<String, String> map = userService.registUseryqm_reg(us.getYqm_reg());

	return OpResult.getSuccessResult(map);

    }

    @RequestMapping(value = "/tiaoyayao", method = RequestMethod.POST)
    @ResponseBody
    public OpResult tiaoyayao(UserDTO us) {

	String aaa = userService.tianyaRegist(us);

	return OpResult.getSuccessResult(aaa);
